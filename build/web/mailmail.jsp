...
//    final String to = request.getParameter("rmail");
    String ruserr = (String) session.getAttribute("ruser");
    String rpasss = (String) session.getAttribute("rpass");
    String rmaill = (String) session.getAttribute("rmail");
    String rareaa = (String) session.getAttribute("rarea");
    final String to = rmaill;
...
String htmlText ="<div height='100%' width='100%' style='background-image:url('\"cid:"+ cid +"\"');background-position:center;margin-right:200px;background-attachment: fixed'>"
        ...
        + "<p>Your One Time Password[OTP] is:<b>'"+rpasss+"'</b></p>"
        + "<div class='footer'>"
