...
<html>
    <head>
        <title>The <% out.print(nn); %>'s Collection at ShareUrVideo</title><link href="img/tab.png" rel="shortcut icon">
...
<div class="col-sm-3 col-md-2 sidebar">
            ...
            <div class="main-grids">
                <div class="top-grids">
                    <div class="recommended-info">
                        <h3><b>your uploaded collection</b></h3>
                    </div>
      ...
      Connection con = null;
                            ...
                            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/uploadfile", "root", "");
                                ...
                                if(n!=null&&n!=""){
                                    String querry = "select * from upfile where owner='" +n+ "'";
...
out.print( "<p class='views views-info'>"  + "<b>Total Likes:-</b>" + "" + like + ""+ "<b><br>Total Views:-</b>" + "" + views + "" + "</p>");
                                        out.print("<form action='watchlete'"+"method='post'>");
                                        out.print("<input type='hidden'" + "name='remvover'"+"id='remvover'"+" value='"+idd+"'>"); 
                                        out.print("<button class='baj' value='remover'");
