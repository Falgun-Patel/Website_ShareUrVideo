...
<html>
    <head>
        <title>ShareUrVideo | Searching</title><link href="img/tab.png" rel="shortcut icon">
            ...
            <div class="main-grids">
                <div class="top-grids">
                    ...
                    <%
                        ResultSet rs = null;
                        Statement ss;
                        String music = request.getParameter("find");
                        try {
                            ...
                            String query = "select * from upfile where categories LIKE '%' '"+ music +"' '%' OR owner LIKE '%' '"+ music +"' '%' OR firstname LIKE '%' '"+ music +"' '%' ORDER BY categories, owner asc";
                            ...
                            while (rs.next()) {
                                ...
                                String views = rs.getString("views");
                                        ...
                                        out.print("<div class='column left'" + "style='background-color:#aaa;'>");
                                        out.print("<img data-u='image'" + "height='100%'"+"width='100%'");
                                        out.print("src='" + "video/" + poster + "'>");
                                        out.print("</div>");

                                        out.print("<div class='column middle'" + "style='background-color:transparent;'>");
                                        out.print("<b><h5>" + title + "</h5></b><br>");
                                        out.print("<b>"+owner+"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+"</b>" + views+"  : views    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp" + timedate +"<br>");
                                        
                                        out.print("<b><h6>" + discre + "<h6></b><br>");
                                        out.print("</div></br>");
                                        out.print("</Button></a></form>");
                                        out.print("</div><hr>");
                            }
                        } catch (Exception e) {
