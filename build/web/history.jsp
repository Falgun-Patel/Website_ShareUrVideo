...
<html>
    <head>
        <title>ShareUrVideo | History</title><link href="img/tab.png" rel="shortcut icon">
            ...
            <div class="main-grids">
                <div class="top-grids">
                    <div class="recommended-info">
                        <h3><b>Your History</b></h3><br><br>
                        <%
                        out.print("<form action='watchlete'"+"method='post'>");
                                        out.print("<input type='hidden'" + "name='removver'"+"id='remover'"+" value='"+n+"'>"); 
                                        out.print("<button value='remover' class='hhaj'");
                                        ...
                                        //out.print("<B>You want to delet pani pete</b>");
                                        out.print("</form>");
                        %>
                    </div>
                            ...
                            while (rs.next()) {
                                ...
                                if (filepat.equals(n)) {
                                    ...
                                    while (rss.next()) {
                                        ...
                                        out.print("<div class='column middle'>");
                                        out.print("&nbsp&nbsp&nbsp&nbsp&nbsp<h5><b>"+title+"</b></h5>");
                                        out.print("&nbsp&nbsp&nbsp&nbsp&nbsp<b>"+ owner + "</b><br>");
                                        out.print("&nbsp&nbsp&nbsp&nbsp&nbsp<big>"+ categories + "</big><br>");
                                        out.print("&nbsp&nbsp&nbsp&nbsp&nbsp<h6><b>"+ timedate + "<b></h6><br>");
                                        out.print("</div></br>");
